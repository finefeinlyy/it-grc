    ...
    <div className="relative bg-[#f4f4f8] min-h-screen text-gray-900 font-sans overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center px-6 pt-32 pb-16">
        ...
        >
          ...
          information security standard designed to reduce fraud and protect
          cardholder data for major credit card companies.
        </motion.p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "Protect systems against malware and maintain secure systems.",
                icon: "🛡️",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Regularly test and monitor networks to ensure compliance.",
                icon: "📊",
              },
            ].map((item, index) => (
              <motion.div
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              PCI DSS was established to unify security practices across major
              credit card companies, enhancing the protection of cardholder data.
              It began with version 1.0 in 2004 and has evolved to address modern
              challenges like encryption and multi-factor authentication.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-3 text-gray-700">
              <li>Reduces fraud and enhances trust among customers.</li>
              <li>Ensures compliance with global security standards.</li>
              <li>Protects cardholder data through robust security controls.</li>
              <li>Streamlines operations with unified security practices.</li>
              <li>Improves risk management across all payment systems.</li>
            </ul>
          </div>
        </motion.div>
      </div>
